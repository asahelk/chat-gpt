...
export function TrashIcon({ className = 'w-4 h-4' }: ClassName) {
  return (
    <svg
      stroke='currentColor'
      fill='none'
...
export const GitHubIcon = ({ className = 'w-6 h-6' }: ClassName) => (
  <svg
    className={className}
    width='16'
    height='16'
...
export const TwitchIcon = ({ className }: ClassName) => {
  return (
...
export function ReactIcon({ className }: ClassName) {
  return (
    <svg
      className={className}
      xmlns='http://www.w3.org/2000/svg'
...
export function PencilIcon({ className = 'w-4  h-4' }: ClassName) {
  return (
    <svg
      stroke='currentColor'
      fill='none'
...
export function StarIcon({ className = 'w-5 h-5' }: ClassName) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      className={className}
...
export function MessageFavIcon({ className = 'w-5 h-5' }: ClassName) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='1em'
...
export function ArrowDownIcon({ className = 'w-5 h-5' }: ClassName) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='1em'
...
export function ArrowRightIcon({ className = 'w-5 h-5' }: ClassName) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='1em'
